...
const poulaillerSchema = new mongoose.Schema(
  {
    ...
    // === CHAMPS SEUILS PERSONNALISÉS PAR POULAILLER ===
    // Ces valeurs sont initialisées lors de la création du poulailler
    // à partir des defaultThresholds de SystemConfig
    // L'éleveur peut ensuite les modifier pour son poulailler uniquement
    seuils: {
      temperatureMin: { type: Number }, // Pas de default - provient de SystemConfig
